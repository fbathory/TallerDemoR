...
- Comentar al menos 2 características de la población total encuestada y 2 de la población que realizó la encuesta
    retrospectiva. Acá podés elegir qué mostrar, pero al menos una de las características tiene que estar segmentada por grupos (puede ser sexo, grupo de edad, nivel educativo).
    
- Presentar resultados con etiquetas, no con códigos.
    
- Realizar un gráfico de barras que muestre alguna variable que te interese.
