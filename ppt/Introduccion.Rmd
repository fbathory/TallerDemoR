...
<!-- mar <- calendR(year = 2025, month = 3,        # Year and month -->
<!--         start = "M",                   # Start the week on Monday -->
<!--         text = c("Intro/U1", "U2", # Add text (only for monthly calendars) -->
<!--                  "U3"), -->
<!--         text.pos = c(18,25),       # Days of the month where to put the texts -->
<!--         text.size = 4.5, -->
<!--         text.col = 1, -->
...
- Solo en CRAN hay más de 22 mil. [Y creciendo día a día](https://rviews.rstudio.com/)
